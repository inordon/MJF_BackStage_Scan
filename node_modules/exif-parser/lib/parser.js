...
var jpeg = require('exif-parser/lib/jpeg'),
	exif = require('exif-parser/lib/exif'),
	simplify = require('exif-parser/lib/simplify');
...
Parser.prototype = {
	...
	parse: function() {
		...
		if(flags.resolveTagNames) {
			tagNames = require('exif-parser/lib/exif-tags');
		}
		if(flags.resolveTagNames) {
			tags = {};
