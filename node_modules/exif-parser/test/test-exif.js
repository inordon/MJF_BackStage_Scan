...
var exif = require('exif-parser/lib/exif.js');
var BufferStream = require('exif-parser/lib/bufferstream.js');
var buf = require('fs').readFileSync(__dirname + '/starfish.jpg');

module.exports = testCase({
	"test parseTags": function(test) {
		var expectedTags = require('exif-parser/test/expected-exif-tags.json');
		var index = 0;
